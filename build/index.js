...
class Navigation {
  ...
  constructor() {
    this.elements = {
      ...
      $hamburger_checked: document.querySelector(".header .hamburger__checkbox")
    };
  ...
  openNavContainer() {
    let openToggle = () => document.querySelector(".header--container").classList.toggle("open");
  ...
  closeMenu(level) {
    ...
    this.elements.$main.forEach($navigation => {
      const $activeSubItems = $navigation.querySelectorAll(itemClass + "." + activeClass);
